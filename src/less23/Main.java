...
public class Main {
	public static final String CONNECTION_URL = "jdbc:mysql://localhost:3306/dim?useSSL=false";
	...
	public static final String SELECT_PERSON_BOOK = "SELECT p.name, p.age, b.title FROM person p JOIN book b ON b.person_id=p.id";
